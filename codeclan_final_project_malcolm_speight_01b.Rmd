...
There is a zero value rather than a missing value. We need to remove this. 
...
newark_other_delays <-
  ...
  select(-c(wind_dir, wind_speed, wind_gust)) # remove unwanted weather variables and keep visib
```
