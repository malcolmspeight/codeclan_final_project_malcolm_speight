...
```
Unsurprisingly, average departure delays are highest in the summer months, fall during the Autumn 
period but rise again during the Christmas break. 

Although average delays were lowest in the first half of 2017 at Newark Airport, this coincided
with a high percentage of flights delayed (see first graph). In the latter half of 2017, 
Newark unfortunately saw their average departure delay exceed that of JFK and La Guardia even 
though the percentage of flights they saw delayed trended in line with the other NYC airports (again,
see graph above). 
